...
def log_peak_memory(training_args):
...
def main():
    ...
    # Reset CUDA peak memory stats before training/eval/predict
    ...
    if training_args.do_train:
        ...
        # ---- PyTorch Profiler block (for GPU kernel/time profiling) ----
        with profile(
        ...
        # Print a summary of the most expensive CUDA ops
        print(
        ...
        # Save a Chrome trace you can inspect if you want
        trace_path = os.path.join(training_args.output_dir, "trace_a2.json")
    ...
    # Log peak GPU memory if we did anything
