...
def main():
    ...
    # Extra logging so you can clearly see when D1 is using torch.compile + aot_eager
    if training_args.torch_compile:
        logger.info(
            f"torch.compile is ENABLED (backend={training_args.torch_compile_backend}, "
            f"mode={training_args.torch_compile_mode})"
        )
    else:
    ...
    if not isinstance(tokenizer, PreTrainedTokenizerFast):
        raise TypeError(
            ...
            "Check the documentation table of supported models."
        )
    ...
    def prepare_train_features(examples):
        ...
        for i, offsets in enumerate(offset_mapping):
            ...
            if len(answers["answer_start"]) == 0:
                ...
                # Character indices of the answer
                ...
                # If answer not fully in this span → CLS
    ...
    def post_processing_function(examples, features, predictions, stage="eval"):
        # Post-processing: map start/end logits to text spans
